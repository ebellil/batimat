...
var $addNewItem = $('<a href="#" class="btn btn-info">Ajouter une nouvelle demande</a>');
// when the page is loaded and ready
$(document).ready(function () {
    // get the collectionHolder, initilize the var by getting the list;
    $collectionHolder = $('#detaildemande_list');
...
function addRemoveButton ($panel) {
    ...
    var $removeButton = $('<a href="#" class="btn btn-danger">Supprimer la demande</a>');
