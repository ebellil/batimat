 ...
 */
final class Version20190512214923 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE demande CHANGE idmat idmat INT NOT NULL, CHANGE Etat Etat TINYINT(1) NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE demande CHANGE Etat Etat TINYINT(1) DEFAULT \'0\', CHANGE idmat idmat INT DEFAULT NULL');
