 ...
 */
final class Version20190512204734 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE demande DROP note, CHANGE idmat idmat INT NOT NULL, CHANGE Etat Etat TINYINT(1) NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE demande ADD note DOUBLE PRECISION DEFAULT NULL, CHANGE Etat Etat TINYINT(1) DEFAULT \'0\', CHANGE idmat idmat INT DEFAULT NULL');
