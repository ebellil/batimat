 ...
 */
final class Version20190405104031 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE demande ADD quantite INT NOT NULL, CHANGE Date Date DATE NOT NULL, CHANGE Etat Etat TINYINT(1) NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE demande DROP quantite, CHANGE Date Date DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL, CHANGE Etat Etat TINYINT(1) DEFAULT \'0\' NOT NULL');
    }
}
